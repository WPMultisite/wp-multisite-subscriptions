<?php
/**
 * WP Multisite Subscriptions activation and deactivation hooks
 *
 * @package WP_Ultimo
 * @subpackage Hooks
 * @since 2.0.0
...
class Hooks {
	...
	public static function init() {
		...
		/**
	 * Runs on WP Multisite Subscriptions activation
	 */
		register_activation_hook(WP_ULTIMO_PLUGIN_FILE, array('WP_Ultimo\Hooks', 'on_activation'));

		/**
		 * Runs on WP Multisite Subscriptions deactivation
		 */
	...
	/**
	 *  Runs when WP Multisite Subscriptions is activated
	 *
	...
	public static function on_activation() {
		...
		wu_log_add('wp-ultimo-core', __('Activating WP Multisite Subscriptions...', 'wp-ultimo'));
	...
	/**
	 * Runs when WP Multisite Subscriptions is deactivated
	 *
	 * @since 1.9.6 It now uses hook-based approach, it is up to each sub-class to attach their own routines.
	 * @since 1.2.0
	 */
	public static function on_deactivation() {
		...
		wu_log_add('wp-ultimo-core', __('Deactivating WP Multisite Subscriptions...', 'wp-ultimo'));
