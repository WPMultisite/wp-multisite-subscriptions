 ...
 * added to the checkout flow and other forms inside WP Multisite Subscriptions.
 *
 ...
 * WP Multisite Subscriptions to be used as the final representation of a given
 * checkout field.
 *
