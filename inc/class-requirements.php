<?php
/**
 * Check if all the pre-requisites to run WP Multisite Subscriptions are in place.
 *
 * @package WP_Ultimo
...
class Requirements {
	...
	/**
	 * Minimum PHP version required to run WP Multisite Subscriptions.
	 *
	 * @since 2.0.0
	 * @var string
	 */
	...
	/**
	 * Minimum WordPress version required to run WP Multisite Subscriptions.
	 *
	 * @since 2.0.0
	 * @var string
	 */
	...
	/**
	 * Check if the minimum pre-requisites to run WP Multisite Subscriptions are present.
	 *
	 ...
	 * - Check if WP Multisite Subscriptions is network active.
	 *
	 * @since 2.0.0
	 * @return boolean
	 */
	...
	public static function notice_unsupported_wp_version() {
		...
		$message = sprintf(__('WP Multisite Subscriptions requires at least WordPress version %1$s to run. Your current WordPress version is <strong>%2$s</strong>.', 'wp-ultimo'), self::$wp_version, $wp_version);
	...
	public static function notice_not_multisite() {
		...
		$message = __('WP Multisite Subscriptions requires a multisite install to run properly. To know more about WordPress Networks, visit this link: <a href="https://wordpress.org/support/article/create-a-network/">Create a Network &rarr;</a>', 'wp-ultimo');
	...
	/**
	 * Adds a network admin notice about the WP Multisite Subscriptions not being network-active
	 *
	 * @since 2.0.0
	 * @return void
	 */
	public static function notice_not_network_active() {
		...
		$message = sprintf(__('WP Multisite Subscriptions needs to be network active to run properly. You can "Network Activate" it <a href="%s">here</a>', 'wp-ultimo'), network_admin_url('plugins.php'));
