	...
	public function get_fields() {
		...
		return array(
			...
			'WU_CLOUDWAYS_EXTRA_DOMAINS' => array(
				...
				'tooltip'     => __('The Cloudways API is a bit strange in that it doesn’t offer a way to add or remove just one domain, only a way to update the whole domain list. That means that WP Multisite Subscriptions will replace all domains you might have there with the list of mapped domains of the network every time a new domain is added.', 'wp-ultimo'),
