...
class Debug {
	...
	/**
     * The registry of WP Multisite Subscriptions admin pages.
     *
     * @since 2.0.0
     * @var array
     */
	...
	public function render_debug_reset_database_form() {
		...
		$fields = array(
			'reset_only_fake_data' => array(
				...
				'desc'      => __('Toggle this option to only remove data that was added by the generator previously. Untoggling this option will reset ALL data in WP Multisite Subscriptions tables.', 'wp-ultimo'),
				'type'      => 'toggle',
				'value'     => true,
				'html_attr' => array(
					'v-model' => 'reset_only',
	...
	public function render_debug_drop_database_form() {
		...
		$fields = array(
			'reset_note'    => array(
				'type' => 'note',
				'desc' => __('This action will drop the WP Multisite Subscriptions database tables and is irreversable.', 'wp-ultimo'),
			),
			'submit_button' => array(
	...
	/**
	 * Add a WP Multisite Subscriptions page to the registry.
	 *
	 * @since 2.0.0
	 *
	...
	private function reset_settings() {
		...
		/*
		 * List of WP Multisite Subscriptions options.
