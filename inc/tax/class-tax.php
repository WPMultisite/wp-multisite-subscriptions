<?php
/**
 * WP Multisite Subscriptions Tax Class.
 *
 * @package WP_Ultimo
 * @subpackage Tax
 * @since 2.0.0
...
class Tax {
	...
	public function add_settings() {
		...
		wu_register_settings_field('taxes', 'inclusive_tax', array(
			...
			'desc'    => __('Enable this option if your prices include taxes. In that case, WP Multisite Subscriptions will calculate the included tax instead of adding taxes to the price.', 'wp-ultimo'),
			'type'    => 'toggle',
			'default' => 0,
			'require' => array(
				'enable_taxes' => 1,
