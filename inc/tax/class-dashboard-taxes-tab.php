<?php
/**
 * WP Multisite Subscriptions Dashboard Tax Admin Panel
 *
 * @package WP_Ultimo
...
class Dashboard_Taxes_Tab {
	...
	public function disabled_message() {
		...
		echo wu_render_empty_state(array(
			...
			'sub_message' => __('If you need to collect taxes, you\'ll be glad to hear that WP Multisite Subscriptions offers tax support!'),
