<?php
/**
 * WP Multisite Subscriptions helper class to handle global registering of scripts and styles.
 *
 * @package WP_Ultimo
 * @subpackage Scripts
 * @since 2.0.0
...
class Scripts {
	...
	/**
	 * Registers the default WP Multisite Subscriptions scripts.
	 *
	 * @since 2.0.0
	 * @return void
	 */
	...
	public function localize_moment() {
		...
		$long_date_formats = array_map('wu_convert_php_date_format_to_moment_js_format', array(
			...
			/* translators: the day/month/year date format used by WP Multisite Subscriptions. You can changed it to localize this date format to your language. the default value is d/m/Y, which is the format 31/12/2021. */
	...
	/**
	 * Registers the default WP Multisite Subscriptions styles.
	 *
	 * @since 2.0.0
	 * @return void
	 */
