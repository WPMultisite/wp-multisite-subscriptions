...
class Inside_Events_List_Table extends Event_List_Table {
	...
	public function column_responsive($item) {
		...
		if ($object_initiator === 'system') {
			...
			$value = sprintf('<span class="dashicons-wu-wp-ultimo wu-align-middle wu-mr-1 wu-text-lg"></span><span class="wu-text-gray-600">%s</span>', __('Automatically processed by WP Multisite Subscriptions', 'wp-ultimo'));
