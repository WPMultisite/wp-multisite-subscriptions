 ...
 * Base List Table class. Extends WP_List_Table.
 *
 * All of WP Multisite Subscriptions's list tables should extend this class.
...
class Base_List_Table extends \WP_List_Table {
	...
	/**
	 * Overrides the parent method to include the custom ajax functionality for WP Multisite Subscriptions.
	 *
	 * @since 2.0.0
	 * @return void
	 */
