<?php
/**
 * WP Multisite Subscriptions Payment Edit/Add New Admin Page.
 *
 * @package WP_Ultimo
	...
	function render_refund_payment_modal() {
		...
		$fields = array(
			...
			'refund_not_immediate_note' => array(
				'type'              => 'note',
				'desc'              => __('Confirming the refund might not immediately change the status of the payment, as each gateway handles refunds differently and WP Multisite Subscriptions relies on the gateway reporting a successful refund before changing the status.', 'wp-ultimo'),
