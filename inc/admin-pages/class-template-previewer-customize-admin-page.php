<?php
/**
 * WP Multisite Subscriptions Customize/Add New Template Previewer Page.
 *
 * @package WP_Ultimo
...
/**
 * WP Multisite Subscriptions Template Previewer Customize/Add New Admin Page.
 */
		...
		$this->add_save_widget('save', array(
			'fields' => array(
				'preview_url_parameter' => array(
					...
					'desc'  => __('This is the URL parameter WP Multisite Subscriptions will use to generate the template preview URLs.', 'wp-ultimo'),
