 ...
 *
 * Most of WP Multisite Subscriptions pages are implemented using this class, which means that the filters and hooks
...
abstract class Base_Admin_Page {
	...
	public function __construct() {
		 ...
		 * being added using WP Multisite Subscriptions code.
		 *
		 * @since 2.0.0
	...
	/**
	 * Adds WP Multisite Subscriptions branding to this page, if that's the case.
	 *
	 * @since 2.0.0
	 * @return void
	 */
	...
	/**
	 * Adds the WP Multisite Subscriptions branding header.
	 *
	 * @since 2.0.0
	 * @return void
	 */
	...
	/**
	 * Adds the WP Multisite Subscriptions branding footer.
	 *
	 * @since 2.0.0
	 * @return void
	 */
	...
	final public function enqueue_default_hooks() {
		...
		if ($this->page_hook) {
			...
			/*
			 * Add the page to WP Multisite Subscriptions branding (aka top-bar and footer)
			 */
			if (is_network_admin()) {
