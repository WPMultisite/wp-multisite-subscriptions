<?php
/**
 * WP Multisite Subscriptions Product Edit/Add New Admin Page.
 *
 * @package WP_Ultimo
		...
		if (wu_request('wu-new-model')) {
			...
			\WP_Ultimo\UI\Tours::get_instance()->create_tour('new_product_warning', array(
				array(
					...
					'text'     => array(
						__("You just successfully added a new product to your WP Multisite Subscriptions network and that's awesome!", 'wp-ultimo'),
			...
			'general' => array(
				...
				'fields' => array(
					...
					'modules[customer_user_role][limit]' => array(
						...
						'desc'              => __('Select the role WP Multisite Subscriptions should use when adding the user to their newly created site.', 'wp-ultimo'),
						'type'              => 'select',
