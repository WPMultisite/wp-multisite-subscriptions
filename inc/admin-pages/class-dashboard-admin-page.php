...
class Dashboard_Admin_Page extends Base_Admin_Page {
	...
	public function register_widgets() {
		 ...
		 * @param \WP_Ultimo\Admin_Pages\Dashboard_Admin_Page $page WP Multisite Subscriptions admin page instance.
		 */
		...
		if (wu_request('tab', 'general') === 'general') {
			...
			\WP_Ultimo\UI\Tours::get_instance()->create_tour('wp-ultimo-dashboard', array(
				array(
					...
					'text'  => array(
						__('This is the <strong>WP Multisite Subscriptions Dashboard</strong>, where you will find most of the important information you will need regarding your business\' performance.', 'wp-ultimo'),
					),
				),
				array(
					'id'       => 'documentation',
					...
					'text'     => array(
						__('Most of the WP Multisite Subscriptions admin pages will contain a link like this one at the top. These will link directly to the relevant knowledge base page on the WP Multisite Subscriptions site.', 'wp-ultimo'),
					),
					'attachTo' => array(
