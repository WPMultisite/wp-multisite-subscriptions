<?php
/**
 * WP Multisite Subscriptions System Info Admin Page.
 *
 * @package WP_Ultimo
...
class System_Info_Admin_Page extends Base_Admin_Page {
		...
		return apply_filters('wu_system_info_data', array(
			'WordPress and System Settings' => array(
				'wp-ultimo-version'      => array(
					'tooltip' => 'WP Multisite Subscriptions current version installed locally',
					'title'   => 'WP Multisite Subscriptions Version',
			...
			'WP Multisite Subscriptions Database Status'     => $array_wu_tables,

			'WP Multisite Subscriptions Core Settings'       => array_merge(
				array(
	...
	/**
	 * Return all the desired WP Multisite Subscriptions Settings
	 *
	 * @since 1.1.5
	 * @return array
	 */
