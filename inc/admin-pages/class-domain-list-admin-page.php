...
class Domain_List_Admin_Page extends List_Admin_Page {
	...
	public function render_add_new_domain_modal() {
		...
		$note_desc = sprintf(__('To activate this feature you need to install the <a href="%s" target="_blank" class="wu-no-underline">WP Multisite Subscriptions: Domain Seller</a> add-on.', 'wp-ultimo'), $addon_url);
		...
		$fields = array(
			...
			'stage'                  => array(
				...
				'desc'        => __('The stage in the domain check lifecycle. Leave "Checking DNS" to have the domain go through WP Multisite Subscriptions\'s automated tests.', 'wp-ultimo'),
