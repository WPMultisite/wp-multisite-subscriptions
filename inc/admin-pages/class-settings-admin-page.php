	...
	public function render_system_emails_side_panel() { ?>
		...
		<div class="wu-widget-inset">
			...
			<div class="wu-p-4">
				...
				<p class="wu-text-gray-600 wu-p-0 wu-m-0">
					<?php _e('You can completely customize the contents of the emails sent out by WP Multisite Subscriptions when particular events occur, such as Account Creation, Payment Failures, etc.', 'wp-ultimo'); ?>
				</p>
