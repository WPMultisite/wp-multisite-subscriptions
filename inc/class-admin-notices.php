<?php
/**
 * Handles the Admin Notices added by WP Multisite Subscriptions.
 *
 * @package WP_Ultimo
...
class Admin_Notices {
	...
	/**
	 * Holds the notices added by WP Multisite Subscriptions.
	 *
	 * @since 2.0.0
	 * @var array
	 */
	...
	public function get_notices($panel = 'admin', $filter = true) {
		...
		/**
		 * Allow developers to filter admin notices added by WP Multisite Subscriptions.
		 *
		 * @since 2.0.0
		 *
