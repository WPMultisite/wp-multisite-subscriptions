...
class Whitelabel {
	...
	public function add_settings() {
		...
		wu_register_settings_field('whitelabel', 'hide_sites_menu', array(
			...
			'desc'    => __('We recommend that you manage all of your sites using the WP Multisite Subscriptions &rarr; Sites page. To avoid confusion, you can hide the default "Sites" item from the WordPress admin menu by toggling this option.', 'wp-ultimo'),
			'type'    => 'toggle',
			'default' => 0,
		));
