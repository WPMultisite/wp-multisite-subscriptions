<?php
/**
 * WP Multisite Subscriptions main class.
 *
 * @package WP_Ultimo
 * @since 2.0.0
 */
...
final class WP_Ultimo {
	...
	/**
	 * Tables registered by WP Multisite Subscriptions.
	 *
	 * @var array
	 */
	public $tables = array();
	...
	/**
	 * Checks if WP Multisite Subscriptions was loaded or not.
	 *
	 * This is set to true when all the WP Multisite Subscriptions requirements are met.
	 *
	 * @since 2.0.0
	 * @var boolean
	 */
	...
	public function init() {
		...
		/*
		 * Loads the WP Multisite Subscriptions settings helper class.
		 */
		...
		/*
		 * Check if the WP Multisite Subscriptions requirements are present.
		 *
		...
		/*
		 * Loads the WP Multisite Subscriptions admin notices helper class.
		 */
		$this->notices = WP_Ultimo\Admin_Notices::get_instance();

		/*
		 * Loads the WP Multisite Subscriptions scripts handler
		 */
	 ...
	 * plugin developers will use when creating extensions for WP Multisite Subscriptions.
	...
	public function load_public_apis() {
		 ...
		 * and the registration elements of WP Multisite Subscriptions.
		 *
	...
	/**
	 * Load extra the WP Multisite Subscriptions elements
	 *
	 * @since 2.0.0
	 * @return void
	 */
	protected function load_extra_components() {
		 ...
		 *
		 * This used to be an add-on on WP Multisite Subscriptions 1.X
		 * Now it is native, but needs to be activated on WP Multisite Subscriptions settings.
		 */
		...
		/*
		 *  Admin Themes Compatibility for WP Multisite Subscriptions
		 */
	...
	/**
	 * Load the WP Multisite Subscriptions Admin Pages.
	 *
	 * @since 2.0.0
	 * @return void
	 */
	...
	/**
	 * Load extra the WP Multisite Subscriptions managers.
	 *
	 * @since 2.0.0
	 * @return void
	 */
