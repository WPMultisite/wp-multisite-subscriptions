<?php
/**
 * WP Multisite Subscriptions helper methods for including and rendering files, assets, etc
 *
 * @package WP_Ultimo
 * @subpackage Helper
 * @since 2.0.0
...
class Helper {
	...
	/**
	 * Creates a WP Multisite Subscriptions folder inside the uploads folder. Returns the path to the folder.
	 *
	 * @since 2.0.0
	 *
	 * @deprecated
