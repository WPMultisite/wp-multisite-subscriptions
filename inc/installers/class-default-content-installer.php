...
class Default_Content_Installer extends Base_Installer {
	...
	/**
	 * Loads dependencies for when WP Multisite Subscriptions is not yet loaded.
	 *
	 * @since 2.0.0
	 * @return void
	 */
	...
	public function get_steps() {
		...
		$steps['create_emails'] = array(
			...
			'description' => __('This action will create all emails sent by WP Multisite Subscriptions.', 'wp-ultimo'),
			'pending'     => __('Pending', 'wp-ultimo'),
