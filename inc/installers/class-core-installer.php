...
class Core_Installer extends Base_Installer {
	...
	public function get_steps() {
		...
		$steps['database_tables'] = array(
			...
			'description' => __('WP Multisite Subscriptions uses custom tables for performance reasons. We need to create those tables and make sure they are setup properly before we can activate the plugin.', 'wp-ultimo'),
	...
	public function _install_sunrise() {
		 ...
		 *
		 * Returning true will prevent WP Multisite Subscriptions from trying to write to the wp-config file.
		 *
		 * @since 2.0.0
