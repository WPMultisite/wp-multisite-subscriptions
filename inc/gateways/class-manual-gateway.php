 ...
 * to implement a custom gateway for WP Multisite Subscriptions.
 *
 * @package WP_Ultimo
 * @subpackage Gateways
 * @since 2.0.0
...
class Manual_Gateway extends Base_Gateway {
	...
	public function process_checkout($payment, $membership, $customer, $cart, $type): bool {
		 ...
		 * simply throw a exception and WP Multisite Subscriptions will
		 ...
		 * WP Multisite Subscriptions will capture that exception and
		 ...
		 * WP Multisite Subscriptions will assume that you want to handle redirection
