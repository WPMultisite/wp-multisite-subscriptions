...
abstract class Base_Gateway {
	 ...
	 * to other gateways.
	 *
	 * A classical example is the way Stripe is setup on WP Multisite Subscriptions now:
	 ...
	 * WP Multisite Subscriptions apis to add settings to the settings
	 * page.
	 *
	 ...
	 *
	 * WP Multisite Subscriptions offers to ways of dealing with free trials:
	 * (1) By asking for a payment method upfront; or
	 * (2) By not asking for a payment method until the trial is over.
	 *
	 * If you go the second route, WP Multisite Subscriptions uses
	...
	public function get_return_url() {
		 ...
		 * @param \WP_Ultimo\Models\Payment $payment the WP Multisite Subscriptions payment instance.
		 * @param \WP_Ultimo\Checkout\Cart  $cart the current WP Multisite Subscriptions cart order.
	   	 * @return string
		 */
