<?php
/**
 * Handles Domain Mapping in WP Multisite Subscriptions.
 *
 * @package WP_Ultimo
...
class Domain_Mapping {
	...
	public function startup() {
		...
		/**
		 * On WP Multisite Subscriptions 1.X builds we used Mercator. The Mercator actions and filters are now deprecated.
		 */
