...
class Signup_Field_Shortcode extends Base_Signup_Field {
	...
	public function get_description() {
		...
		return __('Displays the content of a given WordPress shortcode. Can be useful to inset content from other plugins inside a WP Multisite Subscriptions checkout form.', 'wp-ultimo');
	...
	public function get_tooltip() {
		...
		return __('Displays the content of a given WordPress shortcode. Can be useful to insert content from other plugins inside a WP Multisite Subscriptions checkout form.', 'wp-ultimo');
