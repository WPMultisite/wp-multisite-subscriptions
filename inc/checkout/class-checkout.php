...
class Checkout {
 ...
 protected function maybe_create_customer() {
	...
	protected function handle_customer_meta_fields($customer, $form_slug) {
		...
		if ($checkout_form) {
			 ...
			 * @param Customer $customer The WP Multisite Subscriptions customer object.
 ...
 protected function maybe_create_payment() {
	...
	public function maybe_process_checkout() {
		 ...
		 *
		 * WP Multisite Subscriptions supports multi-step checkout
	...
	public function process_checkout() {
		...
		try {
			 ...
			 * data on the gateway correctly reflects the data on WP Multisite Subscriptions.
			 */
