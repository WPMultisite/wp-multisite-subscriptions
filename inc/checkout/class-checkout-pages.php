...
class Checkout_Pages {
    ...
    <div class="misc-pub-section misc-pub-section-last" style="margin-top: 12px; margin-bottom: 6px; display: flex; align-items: center;">
				<label for="wu-compat-mode">
						<span style="display: block; font-weight: 600; margin-bottom: 3px;"><?php _e('WP Multisite Subscriptions Compatibility Mode', 'wp-ultimo'); ?></span>
						<small style="display: block; line-height: 1.8em;"><?php _e('Toggle this option on if WP Multisite Subscriptions elements are not loading correctly or at all.', 'wp-ultimo'); ?></small>
				</label>
	...
	/**
	 * Returns the ID of the pages being used for each WP Multisite Subscriptions purpose.
	 *
	 * @since 2.0.0
	 * @return array
	 */
 ...
 public function get_page_url($page_slug = 'login') {
	...
	/**
	 * Tags the WP Multisite Subscriptions pages on the main site.
	 *
	 * @since 2.0.0
	 *
	...
	public function add_wp_ultimo_status_annotation($states, $post) {
		...
		$labels = array(
			'register'       => __('WP Multisite Subscriptions - Register Page', 'wp-ultimo'),
			'login'          => __('WP Multisite Subscriptions - Login Page', 'wp-ultimo'),
			'block_frontend' => __('WP Multisite Subscriptions - Site Blocked Page', 'wp-ultimo'),
			'update'         => __('WP Multisite Subscriptions - Membership Update Page', 'wp-ultimo'),
			'new_site'       => __('WP Multisite Subscriptions - New Site Page', 'wp-ultimo'),
		);
