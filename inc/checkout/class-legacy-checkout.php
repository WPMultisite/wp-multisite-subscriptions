...
class Legacy_Checkout {
	...
	public function init() {
		...
		$this->templates = array(
			'signup-main.php' => __('WP Multisite Subscriptions Legacy Signup', 'wp-ultimo'),
		);
...
<?php
	...
	public function get_site_url_for_previewer() {
		 ...
		 * @param array   List of all the domain options entered in the WP Multisite Subscriptions Settings -> Network Settings -> Domain Options
