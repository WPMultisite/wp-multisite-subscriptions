...
class General_Compat {
	 ...
	 * not compatible with WP Multisite Subscriptions vue templates.
	 *
	...
	public function add_wp_typography_warning_message() {
		...
		WP_Ultimo()->notices->add(__('WP Typography "Smart Quotes" replacement is not compatible with WP Multisite Subscriptions and will be automatically disabled.', 'wp-ultimo'), 'warning');
