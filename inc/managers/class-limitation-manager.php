...
class Limitation_Manager {
	...
	/**
	 * Returns a list of all plugins available as options, excluding WP Multisite Subscriptions.
	 *
	 ...
	 *
	 * We don't want people forcing WP Multisite Subscriptions to be deactivated, do we?
	 *
	 * @since 2.0.0
	 * @return array
	 */
