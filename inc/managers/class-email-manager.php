...
class Email_Manager extends Base_Manager {
	...
	public function add_email_fields() {
		...
		wu_register_settings_field('emails', 'from_name', array(
			...
			'desc'        => __('How the sender name will appear in emails sent by WP Multisite Subscriptions.', 'wp-ultimo'),
			'type'        => 'text',
		...
		wu_register_settings_field('emails', 'from_email', array(
			...
			'desc'        => __('How the sender email will appear in emails sent by WP Multisite Subscriptions.', 'wp-ultimo'),
			'type'        => 'email',
