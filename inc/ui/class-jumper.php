...
class Jumper {
	...
	/**
	 * Add WP Multisite Subscriptions settings links to the Jumper menu.
	 *
	 * @since 2.0.0
	 *
	 * @param array $links WP Multisite Subscriptions settings array.
	 * @return array
	 */
	...
	/**
	 * Filter the WP Multisite Subscriptions settings to add Jumper options
	 *
	 * @since 2.0.0
	 *
	 * @return void
