<?php
/**
 * WP Multisite Subscriptions Dashboard Widgets
 *
...
class Dashboard_Widgets {
	...
	public function register_network_widgets() {
		...
		add_meta_box('wp-ultimo-setup', __('WP Multisite Subscriptions - First Steps', 'wp-ultimo'), array($this, 'output_widget_first_steps'), $this->screen_id, 'normal', 'high');

		add_meta_box('wp-ultimo-summary', __('WP Multisite Subscriptions - Summary', 'wp-ultimo'), array($this, 'output_widget_summary'), $this->screen_id, 'normal', 'high');

		add_meta_box('wp-ultimo-activity-stream', __('WP Multisite Subscriptions - Activity Stream', 'wp-ultimo'), array($this, 'output_widget_activity_stream'), $this->screen_id, 'normal', 'high');
		...
		\WP_Ultimo\UI\Tours::get_instance()->create_tour('dashboard', array(
			array(
				...
				'text'  => array(
					...
					__('You will notice that <strong>WP Multisite Subscriptions</strong> adds a couple of useful widgets here so you can keep an eye on how your network is doing.', 'wp-ultimo'),
				),
			),
			array(
			...
			array(
				...
				'text'     => array(
					__('You can always find WP Multisite Subscriptions settings and other pages under our menu item, here on the Network-level dashboard. 😃', 'wp-ultimo'),
				),
				'attachTo' => array(
