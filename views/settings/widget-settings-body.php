          ...
          <tr>
            ...
            <td>
              ...
              <p class="description" id="currency_symbol-desc">
                Select the currency symbol to be used in WP Multisite Subscriptions
              </p>
      ...
      <div id="error_reporting" data-type="heading">
        ...
        <p>Help us make WP Multisite Subscriptions better by automatically reporting fatal errors and warnings so we can fix them as soon
          as possible.</p>
      </div>
      ...
      <table class="form-table">
        <tbody>
          ...
          <tr>
            <th scope="row"><label for="enable_error_reporting">Send Error Data to WP Multisite Subscriptions Developers</label> </th>
            <td>

              <label for="enable_error_reporting">
                <input name="enable_error_reporting" type="checkbox" id="enable_error_reporting" value="1">
                Send Error Data to WP Multisite Subscriptions Developers </label>

              <p class="description" id="enable_error_reporting-desc">
                With this option enabled, every time your installation runs into an error related to WP Multisite Subscriptions, that
          ...
          <tr>
            ...
            <td>
              ...
              <p class="description" id="uninstall_wipe_tables-desc">
                Remove all saved data for WP Multisite Subscriptions when the plugin is uninstalled.
              </p>
