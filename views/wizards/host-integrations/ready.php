...
<div class="wu-bg-white wu-p-4 wu--mx-6 wu-flex wu-content-center" style="height: 250px;">
  ...
  <div class="wu-self-center wu-text-center wu-w-full">
    ...
    <p class="wu-text-lg wu-text-gray-600 wu-my-4">
      <?php printf(__('The integration with %s was correctly setup and is now ready! Now, every time a new domain is added to your platform, WP Multisite Subscriptions will sync that with your application automatically.', 'wp-ultimo'), $integration->get_title()); ?>
    </p>
  </div>
