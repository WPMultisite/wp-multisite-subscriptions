...
<article id="fullArticle">
    ...
    <p class="intercom-align-left">The Cloudways API is a bit strange in that it doesn’t offer a way to add or remove just one domain, only a way to update the whole domain list. That means that WP Multisite Subscriptions <b>will replace all domains</b> you might have there with the list of mapped domains of the network every time a new domain is added.</p>
