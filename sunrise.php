...
// WP Ultimo Starts #
/**
 * WP Multisite Subscriptions Sunrise
 * Plugin URI: https://wpmultisite.com
 * Version: 2.0.0.8
 * License: GPLv2
...
$wu_sunrise = defined('WP_PLUGIN_DIR')
	? WP_PLUGIN_DIR . '/wp-multisite-subscriptions/inc/class-sunrise.php'
	: WP_CONTENT_DIR . '/plugins/wp-multisite-subscriptions/inc/class-sunrise.php';

$wu_mu_sunrise = defined('WPMU_PLUGIN_DIR')
	? WPMU_PLUGIN_DIR . '/wp-multisite-subscriptions/inc/class-sunrise.php'
	: WP_CONTENT_DIR . '/mu-plugins/wp-multisite-subscriptions/inc/class-sunrise.php';
...
$wu_mercator = defined('WP_PLUGIN_DIR')
	? WP_PLUGIN_DIR . '/wp-multisite-subscriptions/inc/mercator/mercator.php'
	: WP_CONTENT_DIR . '/plugins/wp-multisite-subscriptions/inc/mercator/mercator.php';
...
/**
 * Adds a warning when WP Multisite Subscriptions is not present but the sunrise file is.
 *
 * @since 2.0.0
 * @return void
 */
function wu_remove_sunrise_warning() { 
	...
	<div class="notice notice-warning">
		<p>
			WP Multisite Subscriptions is deactivated, yet its <strong>sunrise.php</strong> file is still being loaded. If you have no intentions of continuing to use WP Multisite Subscriptions and this was not a temporary deactivation, we recommend removing the <code>define('SUNRISE', true);</code> line from your <strong>wp-config.php</strong> file. Keeping WP Multisite Subscriptions <strong>sunrise.php</strong> file active without WP Multisite Subscriptions can lead to unexpected behaviors and it is not advised.
		</p>
	</div>
